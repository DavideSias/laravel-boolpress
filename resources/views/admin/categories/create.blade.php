...
@section('content')
    <div class="container">
        <form action="{{ route('admin.categories.store') }}" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" data-sluger="button" data-sluger_url="{{ route('admin.categories.slug')}}">Genera slug</button>
                    </div>
                </div>
            </div>
