        ...
        <form action="{{ route('admin.posts.update', ['post' => $post]) }}" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
              ...
              <div class="col-12">
                ...
                @foreach ($tags as $tag)
                    ...
                    <input class="form-check-input @error('tags') is-invalid @enderror" type="checkbox" value="{{ $tag->id }}" id="tag-{{ $tag->name }}" name="tags[]"
            ...
            <div class="mb-3">
                ...
                <div class="row justify-content-start mt-3">
                    <div class="col-4">
                        Anteprima immagine da modificare:
                        <img class="img-fluid" src="{{ asset('storage/' . $post->uploaded_img) }}" alt="{{ $post->title }}">
                    </div>
                </div>
            </div>
